...
`VerifyError: class <ModuleClass> overrides final method
...
descriptor-change occurrences describe — a `VerifyError` for an overridden final method is reported
at the moment the class is loaded, by the JVM itself, independent of anything this framework's own
module-loading code does.
