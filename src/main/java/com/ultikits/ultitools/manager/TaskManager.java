...
public class TaskManager {
     ...
     * <p>
     * The proxy naming convention is owned by {@link ProxyFactory}, not by this class — see
     * {@link ProxyFactory#isProxyClass(Class)}.
     */
    private Class<?> getTargetClass(Class<?> clazz) {
        Class<?> current = clazz;
        while (ProxyFactory.isProxyClass(current)) {
