...
public class PluginInstallUtils {
    private final static String BASE_URL = UltiTools.getEnv().getString("api-url");
    ...
    public static List<PluginEntity> getPluginList(int page, int pageSize) {
        ...
        HttpRequest get = HttpUtil.createGet(BASE_URL + "/plugin/list?page=" + page + "&pageSize=" + pageSize);
    ...
    public static String getPluginVersionDownloadLink(String idString, String version) {
        ...
        HttpRequest get = HttpUtil.createGet(BASE_URL + "/plugin/" + plugin.getId() + "/" + version + "/download");
        HttpResponse httpResponse = get.execute();
        if (!httpResponse.isOk()) {
            return null;
        }
    ...
    public static List<String> getPluginVersions(String idString) {
        ...
        HttpRequest get = HttpUtil.createGet(BASE_URL + "/plugin/" + plugin.getId() + "/versions");
        HttpResponse httpResponse = get.execute();
        if (!httpResponse.isOk()) {
            return null;
        }
    ...
    public static String getPluginLatestVersion(String idString) {
        ...
        HttpRequest get = HttpUtil.createGet(BASE_URL + "/plugin/" + plugin.getId() + "/latest");
        HttpResponse httpResponse = get.execute();
        if (!httpResponse.isOk()) {
            return null;
        }
    ...
    public static String getPluginLatestDownloadLink(String idString) {
        ...
        HttpRequest get = HttpUtil.createGet(BASE_URL + "/plugin/" + plugin.getId() + "/latest/download");
        HttpResponse httpResponse = get.execute();
        if (!httpResponse.isOk()) {
            return null;
        }
