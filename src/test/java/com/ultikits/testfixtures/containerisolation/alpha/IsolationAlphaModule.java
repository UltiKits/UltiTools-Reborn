 ...
 */
public class IsolationAlphaModule extends UltiToolsPlugin {

    private static IsolationAlphaModule instance;

    @Autowired
    private IsolationAlphaService service;
    ...
    public IsolationAlphaService getService() {
        return service;
    }

    public static IsolationAlphaModule getInstance() {
        return instance;
    }
}
