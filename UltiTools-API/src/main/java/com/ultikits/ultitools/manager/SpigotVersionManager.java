...
public class SpigotVersionManager {
    ...
    public VersionWrapper match() {
        ...
        if (!file.exists()) {
            HttpDownloadUtils.download("http://192.168.0.159:9000/ultitools/versions/" + serverVersion + ".jar", serverVersion + ".jar", UltiTools.getInstance().getDataFolder() + "/versions");
        }
