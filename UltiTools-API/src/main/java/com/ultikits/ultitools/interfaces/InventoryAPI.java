...
public interface InventoryAPI {
     ...
     * 获取Inventory对象
     * <p>
     * You can get the inventory of this InventoryProxy. You must only call this method AFTER call create(),
     * otherwise you will get null.
     * 你可以通过这个方法获取InventoryFactory的Inventory对象。你必须先调用create()方法，否则会返回null！
     *
    ...
    /**
     * Gets group title.
     * 获取这个InventoryFactory的组名
     * <p>
     * Get the group name of this InventoryProxy object if it has a group name.
     * Group name often appears when there are pages hook to the view.
     * 获取这个InventoryFactory对象的组名。
     * 组名一般出现在此界面拥有多个页面时。
     *
     ...
     * @return the boolean
     */
    boolean isBackGround(ItemStack item);
